...
impl Points {
    ...
    const SOURCE_DB:&str = "SEPA_BATHING_WATER_POINTS_BNG_gpkg.zip";
    const TMP_DIR:&str = "tmp";
    const TABLE:&str = "SEPA_BATHING_WATER_POINTS_BNG";
    const DB:&str = "SEPA_BATHING_WATER_POINTS_BNG.gpkg"; 

    pub fn get() -> Vec<Points> {
